...
(function(exports) {
  ...
  var predicate = function (_24) {
      ...
      throw new Error("Failed pattern match at CSS.Render line 148, column 1 - line 149, column 1: " + [ _24.constructor.name ]);
  };
  ...
  var collect$prime = function (_21) {
      return function (_22) {
          ...
          throw new Error("Failed pattern match at CSS.Render line 129, column 1 - line 130, column 1: " + [ _21.constructor.name, _22.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var CSS_Stylesheet = PS["CSS.Stylesheet"];     
  var renderAndInsertStyle = function (_3) {
      return $foreign.addStyleSheet(CSS_Render.renderStyleSheet(_3));
  };
  exports["renderAndInsertStyle"] = renderAndInsertStyle;;
...
(function(exports) {
  ...
  var main = CSS_Compile.renderAndInsertStyle(style);
  exports["style"] = style;
  exports["shake"] = shake;
